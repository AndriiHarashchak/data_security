...
class MD5Hasher {
  Uint32List _digest = Uint32List.fromList([0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476]);
  final List<int> _s = [
  ...
  Uint8List generateMD5Hash(String data) {
    _digest = Uint32List.fromList([0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476]);
